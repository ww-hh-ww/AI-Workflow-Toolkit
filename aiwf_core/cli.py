...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if argv[0] in {"--version", "version"}:
        ...
        return 0
    known = {"init", "install", "doctor", "status", "export-report", "state", "cleanup", "plan", "task", "fixloop", "arch-change", "capability", "recipe", "research", "env", "quality", "idea", "rule", "project-map", "memory", "git", "checkpoint", "goal", "workspace", "asset"}
