---
name: aiwf-critic
description: Manual. Independent project critic — challenges assumptions, finds blind spots, tests whether the project is worth doing. Not for automatic triggering.
---
