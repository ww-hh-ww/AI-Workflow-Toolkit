...
DANGEROUS_BASH_PATTERNS: List[Dict] = [
    ...
    {"pattern": "git stash pop", "decision": "deny", "reason": "stash pop can drop the recovery copy after applying it; AI must use stash apply and leave disposition to the human"},
    {"pattern": "git stash drop", "decision": "deny", "reason": "stash drop destroys a recovery copy and is human-only"},
    {"pattern": "git stash clear", "decision": "deny", "reason": "stash clear destroys every recovery copy and is human-only"},
