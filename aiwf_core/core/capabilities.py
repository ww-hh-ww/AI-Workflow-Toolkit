...
AIWF_SCRIPT_HOOKS = {"scripts/aiwf_status.py", "scripts/aiwf_scope_check.py",
                      "scripts/aiwf_bash_guard.py", "scripts/aiwf_skill_log.py",
                      "scripts/aiwf_agent_log.py", "scripts/aiwf_agent_gate.py",
                      "scripts/aiwf_auto_sync.py", "scripts/aiwf_review_gate.py"}
